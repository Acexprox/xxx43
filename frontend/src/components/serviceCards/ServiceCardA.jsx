        ...
        >
          ...
          >
            <div className="flex items-center gap-1.5 mb-0.5">
              ...
              <div className="text-[13px] font-extrabold leading-tight" style={{ color: "#2A1F10" }}>
                فئات متعددة
              </div>
            </div>
            <div className="text-[12px] leading-relaxed font-semibold" style={{ color: "#6B4E2E" }}>
      ...
      <div className="relative z-10 px-6 mt-3" dir="rtl">
        ...
        >
          <div className="flex items-center justify-start gap-2">
            ...
            <div className="text-[14px] font-extrabold" style={{ color: "#2A1F10" }}>
              باقات متنوعة
            </div>
          </div>
        </div>
